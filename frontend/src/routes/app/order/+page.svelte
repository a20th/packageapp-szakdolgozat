...
<main class="container content">
    ...
    {:else if form?.success}
        <Alert dismissible color="success">
            ...
            Sikeresen leadtad a rendelést! Munkatársunk hamarosan felveszi veled
            a kapcsolatot.
        </Alert>
    {/if}
    ...
    <div class="p-3">
        ...
        >
            <h2 class="text-center mb-3">Rendelés</h2>
            <span
            ...
            <div class="row">
                <div class="col">
                    <FormGroup floating>
                        <Input disabled={submitInProgress} name="from-other" />
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <FormGroup floating>
                            ...
                            />
                            <div slot="label">
                                Full Name / Company <span class="text-danger"
                                    >*</span
                                >
                            </div>
                        </FormGroup>
            ...
            >
            <input type="hidden" name="count" bind:value={packages.length} />
            <Button
                type="submit"
                class="w-100"
